...
export const scholars: Scholar[] = [
...

  {
    ...
    place: { city: "Damas", region: "Syrie", mapKey: "damascus", locationText: "Né près de Damas, il y étudie, y enseigne et y repose. La ville du Shâm fut le cœur de son cheminement." },
    knownFor: [
